# -*- coding: utf-8 -*-
"""
Created on Sun Jan 30 16:13:28 2022
...
{{
    ...
    movement->DifferentialSetup.FrontRearSplit = {FrontRearSplit};

    // Automatic gearbox
    movement->TransmissionSetup.bUseGearAutoBox = true;
    movement->TransmissionSetup.GearSwitchTime = {GearSwitchTime}f;
    movement->TransmissionSetup.GearAutoBoxLatency = {GearAutoBoxLatency}f;
...
Steering_curve_elementary_string = "    movement->SteeringCurve.GetRichCurve()->AddKey({X}f, {Y}f);"
Torque_curve_elementary_string="    movement->EngineSetup.TorqueCurve.GetRichCurve()->AddKey({X}f, {Y}f);"
